...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            journal.loadDataFromFile("src/Laba7/", "data_school.txt");

            journal.printClassesToConsoleAndFiles("src/Laba7/OutData/");
                ...
                switch (choice) {
                    case 1:
                        ...
                        try {
                            ...
                            if (mark >= 2 && mark <= 5) {
                                journal.printStudentsWithMark(mark);
                            } else {
                    ...
                    case 2:
                        ...
                        journal.printClassesSortedByAverage();
                        break;
                    ...
                    case 3:
                        ...
                        journal.printStudentsBySubject(subject);
                        break;
                    ...
                    case 4:
                        ...
                        try {
                            ...
                            if (grade >= 1 && grade <= 11) {
                                journal.printClassSubjectsReport("src/Laba7/OutData/", grade);
                            } else {
                    ...
                    case 5:
                        ...
                        journal.findStudentClass(lastName, firstName);
                        break;

                    case 6:
                        // Задание 6: Предмет с лучшей успеваемостью
                        journal.bestGradesSubject();
                        break;
